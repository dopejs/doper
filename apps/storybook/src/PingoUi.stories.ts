...
const meta: Meta<ShowcaseArgs> = {
  ...
  render: (args) => {
    ...
    return mountStory(
              ...
              children: column([
                ...
                createElement(CardContent, {
                  children: column([
                    ...
                    field(
                      ...
                      column([
                        ...
                        createElement(ToggleGroup, {
                          ...
                          defaultValue: ["center"],
                          children: [
                            createElement(ToggleGroupItem, { value: "left", children: "左" }),
                            createElement(ToggleGroupItem, { value: "center", children: "中" }),
                            createElement(ToggleGroupItem, { value: "right", children: "右" }),
                          ],
                        }),
                      ]),
                    ),
                    ...
                    field(
                      ...
                      column([
                        createElement(Breadcrumb, {
                          items: [{ label: "首页" }, { label: "设置" }, { label: "账号" }],
                        }),
                        spacer(8),
                    ...
                    spacer(16),
                    field("InputOTP", createElement(InputOTP, { length: 6, defaultValue: "12" })),
                    spacer(16),
                    field(
                      "Form",
                      createElement(Form, {
                        children: createElement(FormField, {
                          ...
                          required: true,
                          error: "格式不正确",
                          children: createElement(Input, { value: "not-an-email" }),
                        }),
                      }),
                    ),
                    spacer(16),
                    field(
                      ...
                      createElement("container", {
                        height: 200,
                        children: Table<{ name: string; size: string }>({
                          columns: [
                            {
                              key: "name",
                              header: "名称",
                              cell: (row: { name: string }) =>
                                createElement("text", { value: row.name }),
                            },
                            {
                              key: "size",
                              header: "大小",
                              ...
                              cell: (row: { size: string }) =>
                                createElement("text", { value: row.size }),
                            },
                          ],
                          rowCount: 100000,
                          getRow: (index: number) => ({
                            name: `文件 ${String(index)}`,
                    ...
                    field(
                      ...
                      createElement(Carousel, {
                        loop: true,
                        items: ["一", "二", "三"].map((label) =>
                          createElement(AspectRatio, {
                            ratio: 16 / 9,
                            children: createElement("text", { value: label }),
                          }),
                        ),
                      }),
                    ),
      ...
      { width: 560, height: 5600, styleSheets: [createPingoUiStyleSheet()] },
    );
  },
  args: { theme: "light" },
  argTypes: {
