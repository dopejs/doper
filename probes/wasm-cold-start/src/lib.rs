...
#[allow(unsafe_code)]
#[unsafe(no_mangle)]
pub extern "C" fn doper_probe_abi_version() -> u32 {
    1
}
...
#[allow(unsafe_code)]
#[unsafe(no_mangle)]
pub extern "C" fn doper_probe_mix(mut value: u32) -> u32 {
    value ^= value >> 16;
...
#[cfg(test)]
mod tests {
    use super::{doper_probe_abi_version, doper_probe_mix};

    #[test]
    fn reports_expected_abi_version() {
        assert_eq!(doper_probe_abi_version(), 1);
    }

    #[test]
    fn mixer_is_deterministic_and_non_identity() {
        assert_eq!(doper_probe_mix(42), doper_probe_mix(42));
        assert_ne!(doper_probe_mix(42), 42);
    }
}
