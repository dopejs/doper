...
pub use style_generated::{
    ...
    STYLE_TRANSFORM_SCALE, STYLE_TRANSFORM_TRANSLATE, STYLE_VALUE_F32,
...
mod tests {
    ...
    fn generated_style_metadata_reserves_ids_and_stays_queryable() {
        ...
        assert_eq!(CSS_SUBSET_VERSION, "1.3.0");
        assert_eq!(
            STYLE_ALL_FEATURE_BITS,
            STYLE_FEATURE_M6_FOUNDATION | STYLE_FEATURE_FLEX_SIZING | STYLE_FEATURE_BOX_SHADOW
        );
