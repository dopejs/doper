...
pub use style_generated::{
    ...
    STYLE_FEATURE_FLEX_SIZING, STYLE_FEATURE_M6_FOUNDATION, STYLE_INTERACTION_ACTIVE,
    ...
    STYLE_VALUE_TRANSFORM_LIST, STYLE_VALUE_U16, StyleAnimationType, StyleCanonicalValue,
    StyleKeyword, StyleNodeType, StyleProperty, StyleValueGrammar,
};
...
mod tests {
    ...
    fn generated_style_metadata_reserves_ids_and_stays_queryable() {
        ...
        assert_eq!(CSS_SUBSET_VERSION, "1.2.0");
        assert_eq!(
            STYLE_ALL_FEATURE_BITS,
            STYLE_FEATURE_M6_FOUNDATION | STYLE_FEATURE_FLEX_SIZING
        );
