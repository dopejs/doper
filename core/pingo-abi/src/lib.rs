...
pub use style_generated::{
    ...
    STYLE_FEATURE_POSITIONING, STYLE_FEATURE_Z_INDEX, STYLE_INTERACTION_ACTIVE,
    STYLE_INTERACTION_FOCUS, STYLE_INTERACTION_FOCUS_VISIBLE, STYLE_INTERACTION_HOVER,
    STYLE_INTERACTION_STATE_MASK, STYLE_INVALIDATION_HIT, STYLE_INVALIDATION_LAYOUT,
    STYLE_INVALIDATION_PAINT, STYLE_INVALIDATION_PAINT_SELF, STYLE_INVALIDATION_SCROLL,
    STYLE_INVALIDATION_SEMANTICS, STYLE_LENGTH_AUTO, STYLE_LENGTH_NONE, STYLE_LENGTH_NORMAL,
    STYLE_LENGTH_NUMBER, STYLE_LENGTH_PERCENT, STYLE_LENGTH_PX, STYLE_PROPERTY_COUNT,
    STYLE_PROPERTY_MAX_ID, STYLE_RESERVED_PROPERTY_IDS, STYLE_STATE_PROPERTY_IDS,
    STYLE_TRANSFORM_MATRIX, STYLE_TRANSFORM_ROTATE, STYLE_TRANSFORM_SCALE,
    STYLE_TRANSFORM_TRANSLATE, STYLE_VALUE_F32, STYLE_VALUE_FONT_FAMILY_LIST, STYLE_VALUE_KEYWORD,
    STYLE_VALUE_LENGTH, STYLE_VALUE_LINE_HEIGHT, STYLE_VALUE_POSITION, STYLE_VALUE_RGBA8,
    STYLE_VALUE_SHADOW_LIST, STYLE_VALUE_TRANSFORM_LIST, STYLE_VALUE_U16, StyleAnimationType,
    StyleCanonicalValue, StyleKeyword, StyleNodeType, StyleProperty, StyleValueGrammar,
};
...
mod tests {
    ...
    fn generated_style_metadata_reserves_ids_and_stays_queryable() {
        ...
        assert_eq!(CSS_SUBSET_VERSION, "1.6.0");
        assert_eq!(
    ...
    fn generated_style_keywords_and_property_grammars_are_exhaustively_queryable() {
        ...
        assert_eq!(StyleKeyword::from_u16(53), None);
